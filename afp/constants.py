...
IPFS_LOCAL_NODE_URL = "http://localhost:5001"
...
mainnet = SimpleNamespace(
    EXCHANGE_URL="https://afp-exchange-stable.up.railway.app/",
    CHAIN_ID=65000000,
    CLEARING_DIAMOND_ADDRESS="0x08e725d38BCABCf62806E84bE044dF67E8b476Ae",
    MARGIN_ACCOUNT_REGISTRY_ADDRESS="0x1FAa342Ea34332ee1186FE48f03894F70F7fFc4f",
    ORACLE_PROVIDER_ADDRESS="0x06CaDDDf6CC08048596aE051c8ce644725219C73",
    PRODUCT_REGISTRY_ADDRESS="0xB605fc6B76eA4592CaA3AEd26EFd3edbAc5A3A24",
    SYSTEM_VIEWER_ADDRESS="0xBeC22149650CcaC2a1233c7b489aFF3ea24df36d",
)

bakerloo = SimpleNamespace(
    EXCHANGE_URL="https://exchange-server-staging.up.railway.app/",
    CHAIN_ID=65010004,
    CLEARING_DIAMOND_ADDRESS="0x6Dc8cd65B03e0462C4D5E954b924ec86D3408FE7",
    MARGIN_ACCOUNT_REGISTRY_ADDRESS="0x801cCa84bcb57418044c882Dfb4B03cc35bE848f",
    ORACLE_PROVIDER_ADDRESS="0x72EeD9f7286292f119089F56e3068a3A931FCD49",
    PRODUCT_REGISTRY_ADDRESS="0xab792A6e84c5A22C7A27FEd904AB83ca2fbA4c5e",
    SYSTEM_VIEWER_ADDRESS="0xF2F903B8956Ca6868E165989A9ebEEE72F4D3e3F",
)

TESTNET = os.getenv("AFP_TESTNET") in ("1", "true", "True")
_current_env = bakerloo if TESTNET else mainnet
...
defaults = SimpleNamespace(
    ...
    IPFS_API_URL=os.getenv("AFP_IPFS_API_URL", IPFS_LOCAL_NODE_URL),
    IPFS_API_KEY=os.getenv("AFP_IPFS_API_KEY", None),
    # Blockchain parameters
    RPC_URL=os.getenv("AFP_RPC_URL", None),
    CHAIN_ID=int(os.getenv("AFP_CHAIN_ID", _current_env.CHAIN_ID)),
    ...
    CLEARING_DIAMOND_ADDRESS=os.getenv(
        "AFP_CLEARING_DIAMOND_ADDRESS", _current_env.CLEARING_DIAMOND_ADDRESS
    ),
    MARGIN_ACCOUNT_REGISTRY_ADDRESS=os.getenv(
        "AFP_MARGIN_ACCOUNT_REGISTRY_ADDRESS",
        _current_env.MARGIN_ACCOUNT_REGISTRY_ADDRESS,
    ),
    ORACLE_PROVIDER_ADDRESS=os.getenv(
        "AFP_ORACLE_PROVIDER_ADDRESS",
        _current_env.ORACLE_PROVIDER_ADDRESS,
    ),
    PRODUCT_REGISTRY_ADDRESS=os.getenv(
        "AFP_PRODUCT_REGISTRY_ADDRESS", _current_env.PRODUCT_REGISTRY_ADDRESS
    ),
    SYSTEM_VIEWER_ADDRESS=os.getenv(
        "AFP_SYSTEM_VIEWER_ADDRESS", _current_env.SYSTEM_VIEWER_ADDRESS
    ),
)
